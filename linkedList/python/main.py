...
# myList.remove(7)
myList.remove(6)
print("myList删:", myList.to_array())

# 查
num3 = myList.get(3)
print("myList查:", num3, myList.to_array())

# 改
# myList.set(100, 6)
myList.set(55, 5)
print("myList改:", myList.to_array())

# 中间插入
# myList.insert(200, 8)
myList.insert(100, 3)
print("myList中间插入:", myList.to_array())
# 中间插入-触发扩容
...
myList.insert(1000, 3)
myList.insert(1000, 3)
print("myList中间插入-触发扩容:", myList.to_array(), myList.capacity())
